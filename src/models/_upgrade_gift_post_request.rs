...
pub struct UpgradeGiftPostRequest {
    ...
    #[serde(rename = "keep_original_details", skip_serializing_if = "Option::is_none")]
...
impl UpgradeGiftPostRequest {
    pub fn new(business_connection_id: String, owned_gift_id: String) -> UpgradeGiftPostRequest {
