...
pub struct PostCloseForumTopicRequest {
...
impl PostCloseForumTopicRequest {
    pub fn new(chat_id: models::PostRestrictChatMemberRequestChatId, message_thread_id: i32) -> PostCloseForumTopicRequest {
