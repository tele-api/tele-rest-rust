...
pub struct PostSendChatActionRequest {
...
impl PostSendChatActionRequest {
    pub fn new(chat_id: models::PostSendMessageRequestChatId, action: ActionEnum) -> PostSendChatActionRequest {
