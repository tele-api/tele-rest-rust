...
pub enum InputMessageContent {
    InputTextMessageContent(Box<models::InputTextMessageContent>),
    InputLocationMessageContent(Box<models::InputLocationMessageContent>),
    InputVenueMessageContent(Box<models::InputVenueMessageContent>),
    InputContactMessageContent(Box<models::InputContactMessageContent>),
    InputInvoiceMessageContent(Box<models::InputInvoiceMessageContent>),
}

impl Default for InputMessageContent {
    fn default() -> Self {
        Self::InputTextMessageContent(Default::default())
    }
}
