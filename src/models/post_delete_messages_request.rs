...
pub struct PostDeleteMessagesRequest {
...
impl PostDeleteMessagesRequest {
    pub fn new(chat_id: models::PostSendMessageRequestChatId, message_ids: Vec<i32>) -> PostDeleteMessagesRequest {
