...
pub struct AffiliateInfo {
    #[serde(rename = "affiliate_user", skip_serializing_if = "Option::is_none")]
    pub affiliate_user: Option<Box<models::User>>,
    #[serde(rename = "affiliate_chat", skip_serializing_if = "Option::is_none")]
    pub affiliate_chat: Option<Box<models::Chat>>,
...
impl AffiliateInfo {
    ...
    pub fn new(commission_per_mille: i32, amount: i32) -> AffiliateInfo {
        AffiliateInfo {
            affiliate_user: None,
            affiliate_chat: None,
