...
pub struct PostForwardMessagesRequest {
...
impl PostForwardMessagesRequest {
    pub fn new(chat_id: models::PostSendMessageRequestChatId, from_chat_id: models::PostForwardMessagesRequestFromChatId, message_ids: Vec<i32>) -> PostForwardMessagesRequest {
