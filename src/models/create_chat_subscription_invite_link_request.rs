...
pub struct CreateChatSubscriptionInviteLinkRequest {
    ...
    pub chat_id: Box<models::CreateChatSubscriptionInviteLinkRequestChatId>,
...
impl CreateChatSubscriptionInviteLinkRequest {
    /// Request parameters for createChatSubscriptionInviteLink
    pub fn new(chat_id: models::CreateChatSubscriptionInviteLinkRequestChatId, subscription_period: i32, subscription_price: i32) -> CreateChatSubscriptionInviteLinkRequest {
