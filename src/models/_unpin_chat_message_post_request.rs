...
pub struct UnpinChatMessagePostRequest {
...
impl UnpinChatMessagePostRequest {
    pub fn new(chat_id: models::SendMessagePostRequestChatId) -> UnpinChatMessagePostRequest {
