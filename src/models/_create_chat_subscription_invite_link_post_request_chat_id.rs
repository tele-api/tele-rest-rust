...
pub struct CreateChatSubscriptionInviteLinkPostRequestChatId {
}

impl CreateChatSubscriptionInviteLinkPostRequestChatId {
    /// Unique identifier for the target channel chat or username of the target channel (in the format `@channelusername`)
    pub fn new() -> CreateChatSubscriptionInviteLinkPostRequestChatId {
