...
pub struct SendGiftPostRequest {
    ...
    pub chat_id: Option<Box<models::SendGiftPostRequestChatId>>,
...
impl SendGiftPostRequest {
    pub fn new(gift_id: String) -> SendGiftPostRequest {
        SendGiftPostRequest {
            user_id: None,
            chat_id: None,
            gift_id,
