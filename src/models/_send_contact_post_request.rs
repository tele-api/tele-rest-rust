...
pub struct SendContactPostRequest {
...
impl SendContactPostRequest {
    pub fn new(chat_id: models::SendMessagePostRequestChatId, phone_number: String, first_name: String) -> SendContactPostRequest {
