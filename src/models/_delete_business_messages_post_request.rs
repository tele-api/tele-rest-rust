...
pub struct DeleteBusinessMessagesPostRequest {
...
impl DeleteBusinessMessagesPostRequest {
    pub fn new(business_connection_id: String, message_ids: Vec<i32>) -> DeleteBusinessMessagesPostRequest {
