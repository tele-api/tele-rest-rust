...
pub struct PostCopyMessageRequest {
    ...
    pub from_chat_id: Box<models::PostForwardMessageRequestFromChatId>,
    ...
    pub reply_markup: Option<Box<models::PostSendMessageRequestReplyMarkup>>,
}

impl PostCopyMessageRequest {
    pub fn new(chat_id: models::PostSendMessageRequestChatId, from_chat_id: models::PostForwardMessageRequestFromChatId, message_id: i32) -> PostCopyMessageRequest {
