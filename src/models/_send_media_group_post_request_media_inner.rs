...
pub struct SendMediaGroupPostRequestMediaInner {
    ...
    #[serde(rename = "disable_content_type_detection", skip_serializing_if = "Option::is_none")]
...
impl SendMediaGroupPostRequestMediaInner {
    pub fn new(r#type: String, media: String) -> SendMediaGroupPostRequestMediaInner {
