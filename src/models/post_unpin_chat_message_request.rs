...
pub struct PostUnpinChatMessageRequest {
...
impl PostUnpinChatMessageRequest {
    pub fn new(chat_id: models::PostSendMessageRequestChatId) -> PostUnpinChatMessageRequest {
