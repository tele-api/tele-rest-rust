...
pub struct UploadStickerFileRequest {
    ...
    pub user_id: i32,
    #[serde(rename = "sticker", deserialize_with = "Option::deserialize")]
    pub sticker: Option<serde_json::Value>,
    /// Format of the sticker, must be one of “static”, “animated”, “video”
    #[serde(rename = "sticker_format")]
    pub sticker_format: StickerFormatEnum,
}

impl UploadStickerFileRequest {
    /// Request parameters for uploadStickerFile
    pub fn new(user_id: i32, sticker: Option<serde_json::Value>, sticker_format: StickerFormatEnum) -> UploadStickerFileRequest {
...
impl Default for StickerFormatEnum {
    fn default() -> StickerFormatEnum {
        Self::Static
    }
}
