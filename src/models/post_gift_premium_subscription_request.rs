...
pub struct PostGiftPremiumSubscriptionRequest {
...
impl PostGiftPremiumSubscriptionRequest {
    pub fn new(user_id: i32, month_count: MonthCountEnum, star_count: i32) -> PostGiftPremiumSubscriptionRequest {
