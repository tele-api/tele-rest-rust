...
pub struct CloseForumTopicPostRequest {
...
impl CloseForumTopicPostRequest {
    pub fn new(chat_id: models::RestrictChatMemberPostRequestChatId, message_thread_id: i32) -> CloseForumTopicPostRequest {
