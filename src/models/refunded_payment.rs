...
pub struct RefundedPayment {
    ...
    #[serde(rename = "provider_payment_charge_id", skip_serializing_if = "Option::is_none")]
    pub provider_payment_charge_id: Option<String>,
}

impl RefundedPayment {
    /// This object contains basic information about a refunded payment.
    pub fn new(currency: String, total_amount: i32, invoice_payload: String, telegram_payment_charge_id: String) -> RefundedPayment {
        RefundedPayment {
            currency,
            total_amount,
            invoice_payload,
