...
pub struct ForwardMessageRequest {
    ...
    pub from_chat_id: Box<models::ForwardMessageRequestFromChatId>,
...
impl ForwardMessageRequest {
    ...
    pub fn new(chat_id: models::SendMessageRequestChatId, from_chat_id: models::ForwardMessageRequestFromChatId, message_id: i32) -> ForwardMessageRequest {
