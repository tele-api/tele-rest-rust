...
pub struct PostCopyMessagesRequest {
    #[serde(rename = "chat_id")]
    pub chat_id: Box<models::PostSendMessageRequestChatId>,
    /// Unique identifier for the target message thread (topic) of the forum; for forum supergroups only
    #[serde(rename = "message_thread_id", skip_serializing_if = "Option::is_none")]
    pub message_thread_id: Option<i32>,
    #[serde(rename = "from_chat_id")]
    pub from_chat_id: Box<models::PostForwardMessagesRequestFromChatId>,
    ...
    #[serde(rename = "remove_caption", skip_serializing_if = "Option::is_none")]
    pub remove_caption: Option<bool>,
}

impl PostCopyMessagesRequest {
    pub fn new(chat_id: models::PostSendMessageRequestChatId, from_chat_id: models::PostForwardMessagesRequestFromChatId, message_ids: Vec<i32>) -> PostCopyMessagesRequest {
