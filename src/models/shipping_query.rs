...
pub struct ShippingQuery {
    ...
    pub shipping_address: Box<models::ShippingAddress>,
}

impl ShippingQuery {
    /// This object contains information about an incoming shipping query.
    pub fn new(id: String, from: models::User, invoice_payload: String, shipping_address: models::ShippingAddress) -> ShippingQuery {
        ShippingQuery {
            id,
            from: Box::new(from),
            invoice_payload,
