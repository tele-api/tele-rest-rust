...
pub struct SendVideoNoteRequest {
    ...
    #[serde(rename = "video_note", deserialize_with = "Option::deserialize")]
...
impl SendVideoNoteRequest {
    ...
    pub fn new(chat_id: models::SendMessageRequestChatId, video_note: Option<String>) -> SendVideoNoteRequest {
