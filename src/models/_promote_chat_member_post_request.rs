...
pub struct PromoteChatMemberPostRequest {
...
impl PromoteChatMemberPostRequest {
    pub fn new(chat_id: models::SendMessagePostRequestChatId, user_id: i32) -> PromoteChatMemberPostRequest {
