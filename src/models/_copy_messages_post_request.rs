...
pub struct CopyMessagesPostRequest {
    ...
    pub from_chat_id: Box<models::ForwardMessagesPostRequestFromChatId>,
...
impl CopyMessagesPostRequest {
    pub fn new(chat_id: models::SendMessagePostRequestChatId, from_chat_id: models::ForwardMessagesPostRequestFromChatId, message_ids: Vec<i32>) -> CopyMessagesPostRequest {
