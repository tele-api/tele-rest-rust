...
pub struct ChatBoostRemoved {
    ...
    #[serde(rename = "remove_date")]
    pub remove_date: i32,
    #[serde(rename = "source")]
    pub source: Box<models::ChatBoostSource>,
}

impl ChatBoostRemoved {
    /// This object represents a boost removed from a chat.
    pub fn new(chat: models::Chat, boost_id: String, remove_date: i32, source: models::ChatBoostSource) -> ChatBoostRemoved {
        ChatBoostRemoved {
            chat: Box::new(chat),
            boost_id,
            remove_date,
