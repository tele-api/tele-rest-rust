...
pub struct SendAnimationRequest {
    ...
    #[serde(rename = "animation", deserialize_with = "Option::deserialize")]
...
impl SendAnimationRequest {
    ...
    pub fn new(chat_id: models::SendMessageRequestChatId, animation: Option<String>) -> SendAnimationRequest {
