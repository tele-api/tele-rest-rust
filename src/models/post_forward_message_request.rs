...
pub struct PostForwardMessageRequest {
...
impl PostForwardMessageRequest {
    pub fn new(chat_id: models::PostSendMessageRequestChatId, from_chat_id: models::PostForwardMessageRequestFromChatId, message_id: i32) -> PostForwardMessageRequest {
