...
pub struct PostSendDiceRequest {
...
impl PostSendDiceRequest {
    pub fn new(chat_id: models::PostSendMessageRequestChatId) -> PostSendDiceRequest {
        PostSendDiceRequest {
