...
impl ForwardMessagesRequest {
    /// Request parameters for forwardMessages
    pub fn new(chat_id: models::SendMessageRequestChatId, from_chat_id: models::ForwardMessagesRequestFromChatId, message_ids: Vec<i32>) -> ForwardMessagesRequest {
