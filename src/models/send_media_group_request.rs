...
pub struct SendMediaGroupRequest {
    ...
    #[serde(rename = "media")]
    pub media: Vec<models::SendMediaGroupRequestMediaInner>,
...
impl SendMediaGroupRequest {
    ...
    pub fn new(chat_id: models::SendMessageRequestChatId, media: Vec<models::SendMediaGroupRequestMediaInner>) -> SendMediaGroupRequest {
