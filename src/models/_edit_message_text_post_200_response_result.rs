...
pub struct EditMessageTextPost200ResponseResult {
...
impl EditMessageTextPost200ResponseResult {
    pub fn new(message_id: i32, date: i32, chat: models::Chat) -> EditMessageTextPost200ResponseResult {
