...
pub struct SetBusinessAccountProfilePhotoRequest {
    ...
    #[serde(rename = "photo")]
    pub photo: Box<models::InputProfilePhoto>,
    /// Pass True to set the public photo, which will be visible even if the main photo is hidden by the business account's privacy settings. An account can have only one public photo.
    #[serde(rename = "is_public", skip_serializing_if = "Option::is_none")]
    pub is_public: Option<bool>,
}

impl SetBusinessAccountProfilePhotoRequest {
    /// Request parameters for setBusinessAccountProfilePhoto
    pub fn new(business_connection_id: String, photo: models::InputProfilePhoto) -> SetBusinessAccountProfilePhotoRequest {
