...
pub struct SendInvoicePostRequest {
...
impl SendInvoicePostRequest {
    pub fn new(chat_id: models::SendMessagePostRequestChatId, title: String, description: String, payload: String, currency: String, prices: Vec<models::LabeledPrice>) -> SendInvoicePostRequest {
