...
pub struct UniqueGiftBackdropColors {
    ...
    #[serde(rename = "center_color")]
    pub center_color: i32,
    /// The color on the edges of the backdrop in RGB format
    #[serde(rename = "edge_color")]
    pub edge_color: i32,
    /// The color to be applied to the symbol in RGB format
    #[serde(rename = "symbol_color")]
...
impl UniqueGiftBackdropColors {
    ...
    pub fn new(center_color: i32, edge_color: i32, symbol_color: i32, text_color: i32) -> UniqueGiftBackdropColors {
