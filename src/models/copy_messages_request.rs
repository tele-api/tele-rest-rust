...
pub struct CopyMessagesRequest {
    ...
    pub from_chat_id: Box<models::ForwardMessagesRequestFromChatId>,
...
impl CopyMessagesRequest {
    ...
    pub fn new(chat_id: models::SendMessageRequestChatId, from_chat_id: models::ForwardMessagesRequestFromChatId, message_ids: Vec<i32>) -> CopyMessagesRequest {
        CopyMessagesRequest {
