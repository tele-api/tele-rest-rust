...
pub struct EditForumTopicPostRequest {
...
impl EditForumTopicPostRequest {
    pub fn new(chat_id: models::RestrictChatMemberPostRequestChatId, message_thread_id: i32) -> EditForumTopicPostRequest {
