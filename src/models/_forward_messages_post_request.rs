...
pub struct ForwardMessagesPostRequest {
...
impl ForwardMessagesPostRequest {
    pub fn new(chat_id: models::SendMessagePostRequestChatId, from_chat_id: models::ForwardMessagesPostRequestFromChatId, message_ids: Vec<i32>) -> ForwardMessagesPostRequest {
