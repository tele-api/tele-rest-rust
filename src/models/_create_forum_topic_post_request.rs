...
pub struct CreateForumTopicPostRequest {
...
impl CreateForumTopicPostRequest {
    pub fn new(chat_id: models::RestrictChatMemberPostRequestChatId, name: String) -> CreateForumTopicPostRequest {
