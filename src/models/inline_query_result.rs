...
pub enum InlineQueryResult {
    InlineQueryResultCachedAudio(Box<models::InlineQueryResultCachedAudio>),
    InlineQueryResultCachedDocument(Box<models::InlineQueryResultCachedDocument>),
    InlineQueryResultCachedGif(Box<models::InlineQueryResultCachedGif>),
    InlineQueryResultCachedMpeg4Gif(Box<models::InlineQueryResultCachedMpeg4Gif>),
    InlineQueryResultCachedPhoto(Box<models::InlineQueryResultCachedPhoto>),
    InlineQueryResultCachedSticker(Box<models::InlineQueryResultCachedSticker>),
    InlineQueryResultCachedVideo(Box<models::InlineQueryResultCachedVideo>),
    InlineQueryResultCachedVoice(Box<models::InlineQueryResultCachedVoice>),
    InlineQueryResultArticle(Box<models::InlineQueryResultArticle>),
    InlineQueryResultAudio(Box<models::InlineQueryResultAudio>),
    InlineQueryResultContact(Box<models::InlineQueryResultContact>),
    InlineQueryResultGame(Box<models::InlineQueryResultGame>),
    InlineQueryResultDocument(Box<models::InlineQueryResultDocument>),
    InlineQueryResultGif(Box<models::InlineQueryResultGif>),
    InlineQueryResultLocation(Box<models::InlineQueryResultLocation>),
    InlineQueryResultMpeg4Gif(Box<models::InlineQueryResultMpeg4Gif>),
    InlineQueryResultPhoto(Box<models::InlineQueryResultPhoto>),
    InlineQueryResultVenue(Box<models::InlineQueryResultVenue>),
    InlineQueryResultVideo(Box<models::InlineQueryResultVideo>),
    InlineQueryResultVoice(Box<models::InlineQueryResultVoice>),
}

impl Default for InlineQueryResult {
    fn default() -> Self {
        Self::InlineQueryResultCachedAudio(Default::default())
    }
}
