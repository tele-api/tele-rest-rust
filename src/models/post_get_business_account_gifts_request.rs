...
pub struct PostGetBusinessAccountGiftsRequest {
...
impl PostGetBusinessAccountGiftsRequest {
    pub fn new(business_connection_id: String) -> PostGetBusinessAccountGiftsRequest {
