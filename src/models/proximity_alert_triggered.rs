...
pub struct ProximityAlertTriggered {
    ...
    pub traveler: Box<models::User>,
    #[serde(rename = "watcher")]
    pub watcher: Box<models::User>,
...
impl ProximityAlertTriggered {
    ...
    pub fn new(traveler: models::User, watcher: models::User, distance: i32) -> ProximityAlertTriggered {
        ProximityAlertTriggered {
            traveler: Box::new(traveler),
