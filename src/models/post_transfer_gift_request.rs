...
pub struct PostTransferGiftRequest {
...
impl PostTransferGiftRequest {
    pub fn new(business_connection_id: String, owned_gift_id: String, new_owner_chat_id: i32) -> PostTransferGiftRequest {
