...
pub struct PostSendContactRequest {
...
impl PostSendContactRequest {
    pub fn new(chat_id: models::PostSendMessageRequestChatId, phone_number: String, first_name: String) -> PostSendContactRequest {
