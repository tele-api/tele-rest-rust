...
pub struct UniqueGiftBackdrop {
    ...
    pub name: String,
    #[serde(rename = "colors")]
    pub colors: Box<models::UniqueGiftBackdropColors>,
    /// The number of unique gifts that receive this backdrop for every 1000 gifts upgraded
    #[serde(rename = "rarity_per_mille")]
    pub rarity_per_mille: i32,
}

impl UniqueGiftBackdrop {
    /// This object describes the backdrop of a unique gift.
    pub fn new(name: String, colors: models::UniqueGiftBackdropColors, rarity_per_mille: i32) -> UniqueGiftBackdrop {
        UniqueGiftBackdrop {
            name,
