...
pub struct PostRestrictChatMemberRequest {
...
impl PostRestrictChatMemberRequest {
    pub fn new(chat_id: models::PostRestrictChatMemberRequestChatId, user_id: i32, permissions: models::ChatPermissions) -> PostRestrictChatMemberRequest {
