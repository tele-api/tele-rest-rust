...
#[serde(untagged)]
pub enum ChatMember {
    ChatMemberOwner(Box<models::ChatMemberOwner>),
    ChatMemberAdministrator(Box<models::ChatMemberAdministrator>),
    ChatMemberMember(Box<models::ChatMemberMember>),
    ChatMemberRestricted(Box<models::ChatMemberRestricted>),
    ChatMemberLeft(Box<models::ChatMemberLeft>),
    ChatMemberBanned(Box<models::ChatMemberBanned>),
}

impl Default for ChatMember {
    fn default() -> Self {
        Self::ChatMemberOwner(Default::default())
    }
}
