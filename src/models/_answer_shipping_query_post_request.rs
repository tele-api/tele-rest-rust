...
pub struct AnswerShippingQueryPostRequest {
...
impl AnswerShippingQueryPostRequest {
    pub fn new(shipping_query_id: String, ok: bool) -> AnswerShippingQueryPostRequest {
