...
pub struct PostSendInvoiceRequest {
...
impl PostSendInvoiceRequest {
    pub fn new(chat_id: models::PostSendMessageRequestChatId, title: String, description: String, payload: String, currency: String, prices: Vec<models::LabeledPrice>) -> PostSendInvoiceRequest {
