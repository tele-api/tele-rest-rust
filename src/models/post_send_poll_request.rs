...
pub struct PostSendPollRequest {
...
impl PostSendPollRequest {
    pub fn new(chat_id: models::PostSendMessageRequestChatId, question: String, options: Vec<models::InputPollOption>) -> PostSendPollRequest {
        PostSendPollRequest {
