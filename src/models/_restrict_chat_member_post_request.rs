...
pub struct RestrictChatMemberPostRequest {
    ...
    pub permissions: Box<models::ChatPermissions>,
    ...
    #[serde(rename = "use_independent_chat_permissions", skip_serializing_if = "Option::is_none")]
...
impl RestrictChatMemberPostRequest {
    pub fn new(chat_id: models::RestrictChatMemberPostRequestChatId, user_id: i32, permissions: models::ChatPermissions) -> RestrictChatMemberPostRequest {
