...
pub struct DeleteMessagesPostRequest {
...
impl DeleteMessagesPostRequest {
    pub fn new(chat_id: models::SendMessagePostRequestChatId, message_ids: Vec<i32>) -> DeleteMessagesPostRequest {
