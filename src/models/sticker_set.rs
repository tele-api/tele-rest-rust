...
pub struct StickerSet {
    ...
    pub sticker_type: StickerTypeEnum,
    /// List of all set stickers
    #[serde(rename = "stickers")]
    pub stickers: Vec<models::Sticker>,
...
impl StickerSet {
    ...
    pub fn new(name: String, title: String, sticker_type: StickerTypeEnum, stickers: Vec<models::Sticker>) -> StickerSet {
        StickerSet {
            name,
            title,
            sticker_type,
