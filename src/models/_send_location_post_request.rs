...
pub struct SendLocationPostRequest {
...
impl SendLocationPostRequest {
    pub fn new(chat_id: models::SendMessagePostRequestChatId, latitude: f64, longitude: f64) -> SendLocationPostRequest {
