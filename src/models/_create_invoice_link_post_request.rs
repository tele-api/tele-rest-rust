...
pub struct CreateInvoiceLinkPostRequest {
...
impl CreateInvoiceLinkPostRequest {
    pub fn new(title: String, description: String, payload: String, currency: String, prices: Vec<models::LabeledPrice>) -> CreateInvoiceLinkPostRequest {
