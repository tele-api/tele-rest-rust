...
pub struct PinChatMessagePostRequest {
...
impl PinChatMessagePostRequest {
    pub fn new(chat_id: models::SendMessagePostRequestChatId, message_id: i32) -> PinChatMessagePostRequest {
