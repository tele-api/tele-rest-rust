...
pub struct PostSavePreparedInlineMessageRequest {
...
impl PostSavePreparedInlineMessageRequest {
    pub fn new(user_id: i32, result: models::InlineQueryResult) -> PostSavePreparedInlineMessageRequest {
