...
pub struct PostDeleteBusinessMessagesRequest {
...
impl PostDeleteBusinessMessagesRequest {
    pub fn new(business_connection_id: String, message_ids: Vec<i32>) -> PostDeleteBusinessMessagesRequest {
