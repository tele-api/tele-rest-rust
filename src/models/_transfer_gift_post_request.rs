...
pub struct TransferGiftPostRequest {
    /// Unique identifier of the business connection
    #[serde(rename = "business_connection_id")]
    pub business_connection_id: String,
    /// Unique identifier of the regular gift that should be transferred
    #[serde(rename = "owned_gift_id")]
    pub owned_gift_id: String,
    /// Unique identifier of the chat which will own the gift. The chat must be active in the last 24 hours.
    #[serde(rename = "new_owner_chat_id")]
    pub new_owner_chat_id: i32,
...
impl TransferGiftPostRequest {
    pub fn new(business_connection_id: String, owned_gift_id: String, new_owner_chat_id: i32) -> TransferGiftPostRequest {
