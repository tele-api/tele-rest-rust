...
pub struct PostCreateInvoiceLinkRequest {
...
impl PostCreateInvoiceLinkRequest {
    pub fn new(title: String, description: String, payload: String, currency: String, prices: Vec<models::LabeledPrice>) -> PostCreateInvoiceLinkRequest {
