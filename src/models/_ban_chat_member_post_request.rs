...
pub struct BanChatMemberPostRequest {
...
impl BanChatMemberPostRequest {
    pub fn new(chat_id: models::BanChatMemberPostRequestChatId, user_id: i32) -> BanChatMemberPostRequest {
