...
pub struct ForwardMessagePostRequest {
...
impl ForwardMessagePostRequest {
    pub fn new(chat_id: models::SendMessagePostRequestChatId, from_chat_id: models::ForwardMessagePostRequestFromChatId, message_id: i32) -> ForwardMessagePostRequest {
