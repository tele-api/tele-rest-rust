...
pub struct PostEditMessageLiveLocationRequest {
    ...
    pub chat_id: Option<Box<models::PostEditMessageTextRequestChatId>>,
...
impl PostEditMessageLiveLocationRequest {
    pub fn new(latitude: f64, longitude: f64) -> PostEditMessageLiveLocationRequest {
