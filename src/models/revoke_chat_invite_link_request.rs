...
pub struct RevokeChatInviteLinkRequest {
    ...
    pub chat_id: Box<models::RevokeChatInviteLinkRequestChatId>,
...
impl RevokeChatInviteLinkRequest {
    ...
    pub fn new(chat_id: models::RevokeChatInviteLinkRequestChatId, invite_link: String) -> RevokeChatInviteLinkRequest {
