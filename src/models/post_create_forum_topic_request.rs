...
pub struct PostCreateForumTopicRequest {
...
impl PostCreateForumTopicRequest {
    pub fn new(chat_id: models::PostRestrictChatMemberRequestChatId, name: String) -> PostCreateForumTopicRequest {
