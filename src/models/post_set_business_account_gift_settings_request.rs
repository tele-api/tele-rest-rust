...
pub struct PostSetBusinessAccountGiftSettingsRequest {
    /// Unique identifier of the business connection
    #[serde(rename = "business_connection_id")]
    pub business_connection_id: String,
    /// Pass True, if a button for sending a gift to the user or by the business account must always be shown in the input field
    #[serde(rename = "show_gift_button")]
    pub show_gift_button: bool,
    #[serde(rename = "accepted_gift_types")]
    pub accepted_gift_types: Box<models::AcceptedGiftTypes>,
}

impl PostSetBusinessAccountGiftSettingsRequest {
    pub fn new(business_connection_id: String, show_gift_button: bool, accepted_gift_types: models::AcceptedGiftTypes) -> PostSetBusinessAccountGiftSettingsRequest {
