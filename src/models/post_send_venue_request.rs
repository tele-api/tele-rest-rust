...
pub struct PostSendVenueRequest {
...
impl PostSendVenueRequest {
    pub fn new(chat_id: models::PostSendMessageRequestChatId, latitude: f64, longitude: f64, title: String, address: String) -> PostSendVenueRequest {
