...
pub struct PostAnswerShippingQueryRequest {
...
impl PostAnswerShippingQueryRequest {
    pub fn new(shipping_query_id: String, ok: bool) -> PostAnswerShippingQueryRequest {
