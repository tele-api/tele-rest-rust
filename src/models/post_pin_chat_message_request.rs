...
pub struct PostPinChatMessageRequest {
...
impl PostPinChatMessageRequest {
    pub fn new(chat_id: models::PostSendMessageRequestChatId, message_id: i32) -> PostPinChatMessageRequest {
