...
pub struct SendVenuePostRequest {
...
impl SendVenuePostRequest {
    pub fn new(chat_id: models::SendMessagePostRequestChatId, latitude: f64, longitude: f64, title: String, address: String) -> SendVenuePostRequest {
