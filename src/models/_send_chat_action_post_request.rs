...
pub struct SendChatActionPostRequest {
...
impl SendChatActionPostRequest {
    pub fn new(chat_id: models::SendMessagePostRequestChatId, action: ActionEnum) -> SendChatActionPostRequest {
