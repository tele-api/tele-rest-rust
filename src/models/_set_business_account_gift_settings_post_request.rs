...
pub struct SetBusinessAccountGiftSettingsPostRequest {
...
impl SetBusinessAccountGiftSettingsPostRequest {
    pub fn new(business_connection_id: String, show_gift_button: bool, accepted_gift_types: models::AcceptedGiftTypes) -> SetBusinessAccountGiftSettingsPostRequest {
