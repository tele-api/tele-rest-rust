...
pub struct BusinessConnection {
    ...
    pub user_chat_id: i32,
    /// Date the connection was established in Unix time
    #[serde(rename = "date")]
    pub date: i32,
    #[serde(rename = "rights", skip_serializing_if = "Option::is_none")]
    pub rights: Option<Box<models::BusinessBotRights>>,
...
impl BusinessConnection {
    ...
    pub fn new(id: String, user: models::User, user_chat_id: i32, date: i32, is_enabled: bool) -> BusinessConnection {
        BusinessConnection {
            id,
            user: Box::new(user),
            user_chat_id,
