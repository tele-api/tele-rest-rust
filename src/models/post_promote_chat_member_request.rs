...
pub struct PostPromoteChatMemberRequest {
...
impl PostPromoteChatMemberRequest {
    pub fn new(chat_id: models::PostSendMessageRequestChatId, user_id: i32) -> PostPromoteChatMemberRequest {
