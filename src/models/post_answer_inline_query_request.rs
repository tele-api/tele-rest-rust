...
pub struct PostAnswerInlineQueryRequest {
...
impl PostAnswerInlineQueryRequest {
    pub fn new(inline_query_id: String, results: Vec<models::InlineQueryResult>) -> PostAnswerInlineQueryRequest {
