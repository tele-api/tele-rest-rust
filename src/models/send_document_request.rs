...
pub struct SendDocumentRequest {
    ...
    #[serde(rename = "document", deserialize_with = "Option::deserialize")]
...
impl SendDocumentRequest {
    ...
    pub fn new(chat_id: models::SendMessageRequestChatId, document: Option<String>) -> SendDocumentRequest {
        SendDocumentRequest {
