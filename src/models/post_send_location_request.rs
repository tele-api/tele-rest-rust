...
pub struct PostSendLocationRequest {
...
impl PostSendLocationRequest {
    pub fn new(chat_id: models::PostSendMessageRequestChatId, latitude: f64, longitude: f64) -> PostSendLocationRequest {
