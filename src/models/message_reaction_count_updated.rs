...
pub struct MessageReactionCountUpdated {
    ...
    pub reactions: Vec<models::ReactionCount>,
}

impl MessageReactionCountUpdated {
    /// This object represents reaction changes on a message with anonymous reactions.
    pub fn new(chat: models::Chat, message_id: i32, date: i32, reactions: Vec<models::ReactionCount>) -> MessageReactionCountUpdated {
