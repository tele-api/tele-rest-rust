...
pub struct PostEditForumTopicRequest {
...
impl PostEditForumTopicRequest {
    pub fn new(chat_id: models::PostRestrictChatMemberRequestChatId, message_thread_id: i32) -> PostEditForumTopicRequest {
