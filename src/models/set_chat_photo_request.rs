...
pub struct SetChatPhotoRequest {
    ...
    #[serde(rename = "photo", deserialize_with = "Option::deserialize")]
    pub photo: Option<serde_json::Value>,
}

impl SetChatPhotoRequest {
    /// Request parameters for setChatPhoto
    pub fn new(chat_id: models::SendMessageRequestChatId, photo: Option<serde_json::Value>) -> SetChatPhotoRequest {
        SetChatPhotoRequest {
