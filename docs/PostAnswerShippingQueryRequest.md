...
**shipping_options** | Option<[**Vec<models::ShippingOption>**](ShippingOption.md)> | Required if *ok* is *True*. A JSON-serialized array of available shipping options. | [optional]
