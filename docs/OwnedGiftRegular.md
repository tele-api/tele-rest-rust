...
------------ | ------------- | ------------- | -------------
**r#type** | **String** | Type of the gift, always “regular” | [default to regular]
**gift** | [**models::Gift**](Gift.md) |  | 
**owned_gift_id** | Option<**String**> | *Optional*. Unique identifier of the gift for the bot; for gifts received on behalf of business accounts only | [optional]
