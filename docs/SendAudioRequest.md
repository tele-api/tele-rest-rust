...
**audio** | Option<**String**> |  | 
**caption** | Option<**String**> | Audio caption, 0-1024 characters after entities parsing | [optional]
**parse_mode** | Option<**String**> | Mode for parsing entities in the audio caption. See [formatting options](https://core.telegram.org/bots/api/#formatting-options) for more details. | [optional]
...
**duration** | Option<**i32**> | Duration of the audio in seconds | [optional]
**performer** | Option<**String**> | Performer | [optional]
**title** | Option<**String**> | Track name | [optional]
