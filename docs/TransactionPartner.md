...
------------ | ------------- | ------------- | -------------
**r#type** | **String** | Type of the transaction partner, always “other” | [default to other]
...
**sponsor_user** | Option<[**models::User**](User.md)> |  | [optional]
**commission_per_mille** | **i32** | The number of Telegram Stars received by the bot for each 1000 Telegram Stars received by the affiliate program sponsor from referred users | 
**withdrawal_state** | Option<[**models::RevenueWithdrawalState**](RevenueWithdrawalState.md)> |  | [optional]
**request_count** | **i32** | The number of successful requests that exceeded regular limits and were therefore billed | 
