...
**last_synchronization_error_date** | Option<**i32**> | *Optional*. Unix time of the most recent error that happened when trying to synchronize available updates with Telegram datacenters | [optional]
**max_connections** | Option<**i32**> | *Optional*. The maximum allowed number of simultaneous HTTPS connections to the webhook for update delivery | [optional]
