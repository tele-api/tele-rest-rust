...
------------ | ------------- | ------------- | -------------
**latitude** | **f64** | Latitude as defined by the sender | 
**longitude** | **f64** | Longitude as defined by the sender | 
...
**proximity_alert_radius** | Option<**i32**> | *Optional*. The maximum distance for proximity alerts about approaching another chat member, in meters. For sent live locations only. | [optional]
