...
> models::AddStickerToSetResponse post_add_sticker_to_set(user_id, name, sticker)
addStickerToSet
...
**sticker** | [**models::InputSticker**](InputSticker.md) |  | [required] |

### Return type

[**models::AddStickerToSetResponse**](addStickerToSetResponse.md)
...
> models::AnswerCallbackQueryResponse post_answer_callback_query(callback_query_id, text, show_alert, url, cache_time)
answerCallbackQuery
...
[**models::AnswerCallbackQueryResponse**](answerCallbackQueryResponse.md)
...
> models::AnswerInlineQueryResponse post_answer_inline_query(inline_query_id, results, cache_time, is_personal, next_offset, button)
answerInlineQuery
...
**results** | [**Vec<models::InlineQueryResult>**](models::InlineQueryResult.md) | A JSON-serialized array of results for the inline query | [required] |
...
**button** | Option<[**models::InlineQueryResultsButton**](InlineQueryResultsButton.md)> |  |  |

### Return type

[**models::AnswerInlineQueryResponse**](answerInlineQueryResponse.md)
...
> models::AnswerPreCheckoutQueryResponse post_answer_pre_checkout_query(pre_checkout_query_id, ok, error_message)
...
[**models::AnswerPreCheckoutQueryResponse**](answerPreCheckoutQueryResponse.md)
...
> models::AnswerShippingQueryResponse post_answer_shipping_query(shipping_query_id, ok, shipping_options, error_message)
answerShippingQuery
...
**ok** | **bool** | Pass *True* if delivery to the specified address is possible and *False* if there are any problems (for example, if delivery to the specified address is not possible) | [required] |
**shipping_options** | Option<[**Vec<models::ShippingOption>**](models::ShippingOption.md)> | Required if *ok* is *True*. A JSON-serialized array of available shipping options. |  |
...
[**models::AnswerShippingQueryResponse**](answerShippingQueryResponse.md)
...
> models::AnswerWebAppQueryResponse post_answer_web_app_query(web_app_query_id, result)
answerWebAppQuery
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**web_app_query_id** | **String** | Unique identifier for the query to be answered | [required] |
**result** | [**models::InlineQueryResult**](InlineQueryResult.md) |  | [required] |

### Return type

[**models::AnswerWebAppQueryResponse**](answerWebAppQueryResponse.md)
...
> models::ApproveChatJoinRequestResponse post_approve_chat_join_request(chat_id, user_id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**chat_id** | [**models::SendMessageRequestChatId**](sendMessageRequest_chat_id.md) |  | [required] |
**user_id** | **i32** | Unique identifier of the target user | [required] |

### Return type

[**models::ApproveChatJoinRequestResponse**](approveChatJoinRequestResponse.md)
...
> models::BanChatMemberResponse post_ban_chat_member(chat_id, user_id, until_date, revoke_messages)
banChatMember
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**chat_id** | [**models::BanChatMemberRequestChatId**](banChatMemberRequest_chat_id.md) |  | [required] |
**user_id** | **i32** | Unique identifier of the target user | [required] |
...
[**models::BanChatMemberResponse**](banChatMemberResponse.md)
...
> models::BanChatSenderChatResponse post_ban_chat_sender_chat(chat_id, sender_chat_id)
banChatSenderChat
...
[**models::BanChatSenderChatResponse**](banChatSenderChatResponse.md)
...
> models::CloseResponse post_close()
close
...
[**models::CloseResponse**](closeResponse.md)
...
> models::CloseForumTopicResponse post_close_forum_topic(chat_id, message_thread_id)
closeForumTopic
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**chat_id** | [**models::BotCommandScopeChatChatId**](BotCommandScopeChat_chat_id.md) |  | [required] |
**message_thread_id** | **i32** | Unique identifier for the target message thread of the forum topic | [required] |

### Return type

[**models::CloseForumTopicResponse**](closeForumTopicResponse.md)
...
> models::CloseGeneralForumTopicResponse post_close_general_forum_topic(chat_id)
...
[**models::CloseGeneralForumTopicResponse**](closeGeneralForumTopicResponse.md)
...
> models::ConvertGiftToStarsResponse post_convert_gift_to_stars(business_connection_id, owned_gift_id)
convertGiftToStars
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**business_connection_id** | **String** | Unique identifier of the business connection | [required] |
**owned_gift_id** | **String** | Unique identifier of the regular gift that should be converted to Telegram Stars | [required] |

### Return type

[**models::ConvertGiftToStarsResponse**](convertGiftToStarsResponse.md)
...
> models::CopyMessageResponse post_copy_message(chat_id, from_chat_id, message_id, message_thread_id, video_start_timestamp, caption, parse_mode, caption_entities, show_caption_above_media, disable_notification, protect_content, allow_paid_broadcast, reply_parameters, reply_markup)
copyMessage
...
------------- | ------------- | ------------- | ------------- | -------------
**chat_id** | [**models::SendMessageRequestChatId**](sendMessageRequest_chat_id.md) |  | [required] |
**from_chat_id** | [**models::ForwardMessageRequestFromChatId**](forwardMessageRequest_from_chat_id.md) |  | [required] |
...
**caption_entities** | Option<[**Vec<models::MessageEntity>**](models::MessageEntity.md)> | A JSON-serialized list of special entities that appear in the new caption, which can be specified instead of *parse\\\\_mode* |  |
...
**reply_markup** | Option<[**models::SendMessageRequestReplyMarkup**](sendMessageRequest_reply_markup.md)> |  |  |

### Return type

[**models::CopyMessageResponse**](copyMessageResponse.md)
...
> models::CopyMessagesResponse post_copy_messages(chat_id, from_chat_id, message_ids, message_thread_id, disable_notification, protect_content, remove_caption)
copyMessages
...
------------- | ------------- | ------------- | ------------- | -------------
**chat_id** | [**models::SendMessageRequestChatId**](sendMessageRequest_chat_id.md) |  | [required] |
**from_chat_id** | [**models::ForwardMessagesRequestFromChatId**](forwardMessagesRequest_from_chat_id.md) |  | [required] |
...
[**models::CopyMessagesResponse**](copyMessagesResponse.md)
...
> models::CreateChatInviteLinkResponse post_create_chat_invite_link(chat_id, name, expire_date, member_limit, creates_join_request)
...
**creates_join_request** | Option<**bool**> | *True*, if users joining the chat via the link need to be approved by chat administrators. If *True*, *member\\\\_limit* can't be specified |  |

### Return type

[**models::CreateChatInviteLinkResponse**](createChatInviteLinkResponse.md)
...
> models::CreateChatSubscriptionInviteLinkResponse post_create_chat_subscription_invite_link(chat_id, subscription_period, subscription_price, name)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**chat_id** | [**models::CreateChatSubscriptionInviteLinkRequestChatId**](createChatSubscriptionInviteLinkRequest_chat_id.md) |  | [required] |
...
[**models::CreateChatSubscriptionInviteLinkResponse**](createChatSubscriptionInviteLinkResponse.md)
...
> models::CreateForumTopicResponse post_create_forum_topic(chat_id, name, icon_color, icon_custom_emoji_id)
createForumTopic
...
[**models::CreateForumTopicResponse**](createForumTopicResponse.md)
...
> models::CreateInvoiceLinkResponse post_create_invoice_link(title, description, payload, currency, prices, business_connection_id, provider_token, subscription_period, max_tip_amount, suggested_tip_amounts, provider_data, photo_url, photo_size, photo_width, photo_height, need_name, need_phone_number, need_email, need_shipping_address, send_phone_number_to_provider, send_email_to_provider, is_flexible)
createInvoiceLink
...
**currency** | **String** | Three-letter ISO 4217 currency code, see [more on currencies](https://core.telegram.org/bots/payments#supported-currencies). Pass “XTR” for payments in [Telegram Stars](https://t.me/BotNews/90). | [required] |
**prices** | [**Vec<models::LabeledPrice>**](models::LabeledPrice.md) | Price breakdown, a JSON-serialized list of components (e.g. product price, tax, discount, delivery cost, delivery tax, bonus, etc.). Must contain exactly one item for payments in [Telegram Stars](https://t.me/BotNews/90). | [required] |
**business_connection_id** | Option<**String**> | Unique identifier of the business connection on behalf of which the link will be created. For payments in [Telegram Stars](https://t.me/BotNews/90) only. |  |
**provider_token** | Option<**String**> | Payment provider token, obtained via [@BotFather](https://t.me/botfather). Pass an empty string for payments in [Telegram Stars](https://t.me/BotNews/90). |  |
...
**suggested_tip_amounts** | Option<[**Vec<i32>**](i32.md)> | A JSON-serialized array of suggested amounts of tips in the *smallest units* of the currency (integer, **not** float/double). At most 4 suggested tip amounts can be specified. The suggested tip amounts must be positive, passed in a strictly increased order and must not exceed *max\\\\_tip\\\\_amount*. |  |
...
**photo_size** | Option<**i32**> | Photo size in bytes |  |
**photo_width** | Option<**i32**> | Photo width |  |
**photo_height** | Option<**i32**> | Photo height |  |
**need_name** | Option<**bool**> | Pass *True* if you require the user's full name to complete the order. Ignored for payments in [Telegram Stars](https://t.me/BotNews/90). |  |
**need_phone_number** | Option<**bool**> | Pass *True* if you require the user's phone number to complete the order. Ignored for payments in [Telegram Stars](https://t.me/BotNews/90). |  |
**need_email** | Option<**bool**> | Pass *True* if you require the user's email address to complete the order. Ignored for payments in [Telegram Stars](https://t.me/BotNews/90). |  |
**need_shipping_address** | Option<**bool**> | Pass *True* if you require the user's shipping address to complete the order. Ignored for payments in [Telegram Stars](https://t.me/BotNews/90). |  |
**send_phone_number_to_provider** | Option<**bool**> | Pass *True* if the user's phone number should be sent to the provider. Ignored for payments in [Telegram Stars](https://t.me/BotNews/90). |  |
**send_email_to_provider** | Option<**bool**> | Pass *True* if the user's email address should be sent to the provider. Ignored for payments in [Telegram Stars](https://t.me/BotNews/90). |  |
**is_flexible** | Option<**bool**> | Pass *True* if the final price depends on the shipping method. Ignored for payments in [Telegram Stars](https://t.me/BotNews/90). |  |

### Return type

[**models::CreateInvoiceLinkResponse**](createInvoiceLinkResponse.md)
...
> models::CreateNewStickerSetResponse post_create_new_sticker_set(user_id, name, title, stickers, sticker_type, needs_repainting)
createNewStickerSet
...
**name** | **String** | Short name of sticker set, to be used in `t.me/addstickers/` URLs (e.g., *animals*). Can contain only English letters, digits and underscores. Must begin with a letter, can't contain consecutive underscores and must end in `\\\"_by_<bot_username>\\\"`. `<bot_username>` is case insensitive. 1-64 characters. | [required] |
**title** | **String** | Sticker set title, 1-64 characters | [required] |
**stickers** | [**Vec<models::InputSticker>**](models::InputSticker.md) | A JSON-serialized list of 1-50 initial stickers to be added to the sticker set | [required] |
**sticker_type** | Option<**String**> | Type of stickers in the set, pass “regular”, “mask”, or “custom\\\\_emoji”. By default, a regular sticker set is created. |  |
...
[**models::CreateNewStickerSetResponse**](createNewStickerSetResponse.md)
...
> models::DeclineChatJoinRequestResponse post_decline_chat_join_request(chat_id, user_id)
...
[**models::DeclineChatJoinRequestResponse**](declineChatJoinRequestResponse.md)
...
> models::DeleteBusinessMessagesResponse post_delete_business_messages(business_connection_id, message_ids)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**business_connection_id** | **String** | Unique identifier of the business connection on behalf of which to delete the messages | [required] |
**message_ids** | [**Vec<i32>**](i32.md) | A JSON-serialized list of 1-100 identifiers of messages to delete. All messages must be from the same chat. See [deleteMessage](https://core.telegram.org/bots/api/#deletemessage) for limitations on which messages can be deleted | [required] |

### Return type

[**models::DeleteBusinessMessagesResponse**](deleteBusinessMessagesResponse.md)
...
> models::DeleteChatPhotoResponse post_delete_chat_photo(chat_id)
deleteChatPhoto
...
[**models::DeleteChatPhotoResponse**](deleteChatPhotoResponse.md)
...
> models::DeleteChatStickerSetResponse post_delete_chat_sticker_set(chat_id)
...
[**models::DeleteChatStickerSetResponse**](deleteChatStickerSetResponse.md)
...
> models::DeleteForumTopicResponse post_delete_forum_topic(chat_id, message_thread_id)
deleteForumTopic
...
[**models::DeleteForumTopicResponse**](deleteForumTopicResponse.md)
...
> models::DeleteMessageResponse post_delete_message(chat_id, message_id)
deleteMessage
...
> models::DeleteMessagesResponse post_delete_messages(chat_id, message_ids)
deleteMessages
...
[**models::DeleteMessagesResponse**](deleteMessagesResponse.md)
...
> models::DeleteMyCommandsResponse post_delete_my_commands(scope, language_code)
deleteMyCommands
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**scope** | Option<[**models::BotCommandScope**](BotCommandScope.md)> |  |  |
...
[**models::DeleteMyCommandsResponse**](deleteMyCommandsResponse.md)
...
> models::DeleteStickerFromSetResponse post_delete_sticker_from_set(sticker)
...
[**models::DeleteStickerFromSetResponse**](deleteStickerFromSetResponse.md)
...
> models::DeleteStickerSetResponse post_delete_sticker_set(name)
deleteStickerSet
...
[**models::DeleteStickerSetResponse**](deleteStickerSetResponse.md)
...
> models::DeleteStoryResponse post_delete_story(business_connection_id, story_id)
deleteStory
...
------------- | ------------- | ------------- | ------------- | -------------
**business_connection_id** | **String** | Unique identifier of the business connection | [required] |
**story_id** | **i32** | Unique identifier of the story to delete | [required] |

### Return type

[**models::DeleteStoryResponse**](deleteStoryResponse.md)
...
> models::DeleteWebhookResponse post_delete_webhook(drop_pending_updates)
deleteWebhook
...
> models::EditChatInviteLinkResponse post_edit_chat_invite_link(chat_id, invite_link, name, expire_date, member_limit, creates_join_request)
editChatInviteLink
...
[**models::EditChatInviteLinkResponse**](editChatInviteLinkResponse.md)
...
> models::EditChatSubscriptionInviteLinkResponse post_edit_chat_subscription_invite_link(chat_id, invite_link, name)
editChatSubscriptionInviteLink
...
[**models::EditChatSubscriptionInviteLinkResponse**](editChatSubscriptionInviteLinkResponse.md)
...
> models::EditForumTopicResponse post_edit_forum_topic(chat_id, message_thread_id, name, icon_custom_emoji_id)
editForumTopic
...
[**models::EditForumTopicResponse**](editForumTopicResponse.md)
...
> models::EditGeneralForumTopicResponse post_edit_general_forum_topic(chat_id, name)
...
[**models::EditGeneralForumTopicResponse**](editGeneralForumTopicResponse.md)
...
> models::EditMessageCaptionResponse post_edit_message_caption(business_connection_id, chat_id, message_id, inline_message_id, caption, parse_mode, caption_entities, show_caption_above_media, reply_markup)
editMessageCaption
...
**chat_id** | Option<[**models::EditMessageTextRequestChatId**](editMessageTextRequest_chat_id.md)> |  |  |
...
[**models::EditMessageCaptionResponse**](editMessageCaptionResponse.md)
...
> models::EditMessageLiveLocationResponse post_edit_message_live_location(latitude, longitude, business_connection_id, chat_id, message_id, inline_message_id, live_period, horizontal_accuracy, heading, proximity_alert_radius, reply_markup)
...
**proximity_alert_radius** | Option<**i32**> | The maximum distance for proximity alerts about approaching another chat member, in meters. Must be between 1 and 100000 if specified. |  |
**reply_markup** | Option<[**models::InlineKeyboardMarkup**](InlineKeyboardMarkup.md)> |  |  |

### Return type

[**models::EditMessageLiveLocationResponse**](editMessageLiveLocationResponse.md)
...
> models::EditMessageMediaResponse post_edit_message_media(media, business_connection_id, chat_id, message_id, inline_message_id, reply_markup)
editMessageMedia
...
[**models::EditMessageMediaResponse**](editMessageMediaResponse.md)
...
> models::EditMessageReplyMarkupResponse post_edit_message_reply_markup(business_connection_id, chat_id, message_id, inline_message_id, reply_markup)
...
[**models::EditMessageReplyMarkupResponse**](editMessageReplyMarkupResponse.md)
...
> models::EditMessageTextResponse post_edit_message_text(text, business_connection_id, chat_id, message_id, inline_message_id, parse_mode, entities, link_preview_options, reply_markup)
editMessageText
...
**entities** | Option<[**Vec<models::MessageEntity>**](models::MessageEntity.md)> | A JSON-serialized list of special entities that appear in message text, which can be specified instead of *parse\\\\_mode* |  |
**link_preview_options** | Option<[**models::LinkPreviewOptions**](LinkPreviewOptions.md)> |  |  |
**reply_markup** | Option<[**models::InlineKeyboardMarkup**](InlineKeyboardMarkup.md)> |  |  |

### Return type

[**models::EditMessageTextResponse**](editMessageTextResponse.md)
...
> models::EditStoryResponse post_edit_story(business_connection_id, story_id, content, caption, parse_mode, caption_entities, areas)
editStory
...
------------- | ------------- | ------------- | ------------- | -------------
**business_connection_id** | **String** | Unique identifier of the business connection | [required] |
**story_id** | **i32** | Unique identifier of the story to edit | [required] |
**content** | [**models::InputStoryContent**](InputStoryContent.md) |  | [required] |
**caption** | Option<**String**> | Caption of the story, 0-2048 characters after entities parsing |  |
**parse_mode** | Option<**String**> | Mode for parsing entities in the story caption. See [formatting options](https://core.telegram.org/bots/api/#formatting-options) for more details. |  |
**caption_entities** | Option<[**Vec<models::MessageEntity>**](models::MessageEntity.md)> | A JSON-serialized list of special entities that appear in the caption, which can be specified instead of *parse\\\\_mode* |  |
**areas** | Option<[**Vec<models::StoryArea>**](models::StoryArea.md)> | A JSON-serialized list of clickable areas to be shown on the story |  |

### Return type

[**models::EditStoryResponse**](editStoryResponse.md)
...
> models::EditUserStarSubscriptionResponse post_edit_user_star_subscription(user_id, telegram_payment_charge_id, is_canceled)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**user_id** | **i32** | Identifier of the user whose subscription will be edited | [required] |
**telegram_payment_charge_id** | **String** | Telegram payment identifier for the subscription | [required] |
**is_canceled** | **bool** | Pass *True* to cancel extension of the user subscription; the subscription must be active up to the end of the current subscription period. Pass *False* to allow the user to re-enable a subscription that was previously canceled by the bot. | [required] |

### Return type

[**models::EditUserStarSubscriptionResponse**](editUserStarSubscriptionResponse.md)
...
> models::ExportChatInviteLinkResponse post_export_chat_invite_link(chat_id)
...
[**models::ExportChatInviteLinkResponse**](exportChatInviteLinkResponse.md)
...
> models::ForwardMessageResponse post_forward_message(chat_id, from_chat_id, message_id, message_thread_id, video_start_timestamp, disable_notification, protect_content)
forwardMessage
...
[**models::ForwardMessageResponse**](forwardMessageResponse.md)
...
> models::ForwardMessagesResponse post_forward_messages(chat_id, from_chat_id, message_ids, message_thread_id, disable_notification, protect_content)
forwardMessages
...
[**models::ForwardMessagesResponse**](forwardMessagesResponse.md)
...
> models::GetAvailableGiftsResponse post_get_available_gifts()
getAvailableGifts
...
[**models::GetAvailableGiftsResponse**](getAvailableGiftsResponse.md)
...
> models::GetBusinessAccountGiftsResponse post_get_business_account_gifts(business_connection_id, exclude_unsaved, exclude_saved, exclude_unlimited, exclude_limited, exclude_unique, sort_by_price, offset, limit)
...
**exclude_limited** | Option<**bool**> | Pass True to exclude gifts that can be purchased a limited number of times |  |
...
**limit** | Option<**i32**> | The maximum number of gifts to be returned; 1-100. Defaults to 100 |  |[default to 100]

### Return type

[**models::GetBusinessAccountGiftsResponse**](getBusinessAccountGiftsResponse.md)
...
> models::GetBusinessAccountStarBalanceResponse post_get_business_account_star_balance(business_connection_id)
...
[**models::GetBusinessAccountStarBalanceResponse**](getBusinessAccountStarBalanceResponse.md)
...
> models::GetBusinessConnectionResponse post_get_business_connection(business_connection_id)
...
[**models::GetBusinessConnectionResponse**](getBusinessConnectionResponse.md)
...
> models::GetChatResponse post_get_chat(chat_id)
getChat
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**chat_id** | [**models::LeaveChatRequestChatId**](leaveChatRequest_chat_id.md) |  | [required] |

### Return type

[**models::GetChatResponse**](getChatResponse.md)
...
> models::GetChatAdministratorsResponse post_get_chat_administrators(chat_id)
...
[**models::GetChatAdministratorsResponse**](getChatAdministratorsResponse.md)
...
> models::GetChatMemberResponse post_get_chat_member(chat_id, user_id)
getChatMember
...
[**models::GetChatMemberResponse**](getChatMemberResponse.md)
...
> models::GetChatMemberCountResponse post_get_chat_member_count(chat_id)
getChatMemberCount
...
[**models::GetChatMemberCountResponse**](getChatMemberCountResponse.md)
...
> models::GetChatMenuButtonResponse post_get_chat_menu_button(chat_id)
getChatMenuButton
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**chat_id** | Option<**i32**> | Unique identifier for the target private chat. If not specified, default bot's menu button will be returned |  |

### Return type

[**models::GetChatMenuButtonResponse**](getChatMenuButtonResponse.md)
...
> models::GetCustomEmojiStickersResponse post_get_custom_emoji_stickers(custom_emoji_ids)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**custom_emoji_ids** | [**Vec<String>**](String.md) | A JSON-serialized list of custom emoji identifiers. At most 200 custom emoji identifiers can be specified. | [required] |

### Return type

[**models::GetCustomEmojiStickersResponse**](getCustomEmojiStickersResponse.md)
...
> models::GetFileResponse post_get_file(file_id)
getFile
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**file_id** | **String** | File identifier to get information about | [required] |
...
> models::GetForumTopicIconStickersResponse post_get_forum_topic_icon_stickers()
...
[**models::GetForumTopicIconStickersResponse**](getForumTopicIconStickersResponse.md)
...
> models::GetGameHighScoresResponse post_get_game_high_scores(user_id, chat_id, message_id, inline_message_id)
getGameHighScores
...
[**models::GetGameHighScoresResponse**](getGameHighScoresResponse.md)
...
> models::GetMeResponse post_get_me()
getMe
...
> models::GetMyCommandsResponse post_get_my_commands(scope, language_code)
getMyCommands
...
[**models::GetMyCommandsResponse**](getMyCommandsResponse.md)
...
> models::GetMyDefaultAdministratorRightsResponse post_get_my_default_administrator_rights(for_channels)
...
[**models::GetMyDefaultAdministratorRightsResponse**](getMyDefaultAdministratorRightsResponse.md)
...
> models::GetMyDescriptionResponse post_get_my_description(language_code)
getMyDescription
...
[**models::GetMyDescriptionResponse**](getMyDescriptionResponse.md)
...
> models::GetMyNameResponse post_get_my_name(language_code)
getMyName
...
[**models::GetMyNameResponse**](getMyNameResponse.md)
...
> models::GetMyShortDescriptionResponse post_get_my_short_description(language_code)
...
[**models::GetMyShortDescriptionResponse**](getMyShortDescriptionResponse.md)
...
> models::GetStarTransactionsResponse post_get_star_transactions(offset, limit)
getStarTransactions
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**offset** | Option<**i32**> | Number of transactions to skip in the response |  |
**limit** | Option<**i32**> | The maximum number of transactions to be retrieved. Values between 1-100 are accepted. Defaults to 100. |  |[default to 100]

### Return type

[**models::GetStarTransactionsResponse**](getStarTransactionsResponse.md)
...
> models::GetStickerSetResponse post_get_sticker_set(name)
getStickerSet
...
[**models::GetStickerSetResponse**](getStickerSetResponse.md)
...
> models::GetUpdatesResponse post_get_updates(offset, limit, timeout, allowed_updates)
getUpdates
...
**allowed_updates** | Option<[**Vec<String>**](String.md)> | A JSON-serialized list of the update types you want your bot to receive. For example, specify `[\\\"message\\\", \\\"edited_channel_post\\\", \\\"callback_query\\\"]` to only receive updates of these types. See [Update](https://core.telegram.org/bots/api/#update) for a complete list of available update types. Specify an empty list to receive all update types except *chat\\\\_member*, *message\\\\_reaction*, and *message\\\\_reaction\\\\_count* (default). If not specified, the previous setting will be used.    Please note that this parameter doesn't affect updates created before the call to getUpdates, so unwanted updates may be received for a short period of time. |  |

### Return type

[**models::GetUpdatesResponse**](getUpdatesResponse.md)
...
> models::GetUserChatBoostsResponse post_get_user_chat_boosts(chat_id, user_id)
getUserChatBoosts
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**chat_id** | [**models::GetUserChatBoostsRequestChatId**](getUserChatBoostsRequest_chat_id.md) |  | [required] |
**user_id** | **i32** | Unique identifier of the target user | [required] |

### Return type

[**models::GetUserChatBoostsResponse**](getUserChatBoostsResponse.md)
...
> models::GetUserProfilePhotosResponse post_get_user_profile_photos(user_id, offset, limit)
...
[**models::GetUserProfilePhotosResponse**](getUserProfilePhotosResponse.md)
...
> models::GetWebhookInfoResponse post_get_webhook_info()
getWebhookInfo
...
[**models::GetWebhookInfoResponse**](getWebhookInfoResponse.md)
...
> models::GiftPremiumSubscriptionResponse post_gift_premium_subscription(user_id, month_count, star_count, text, text_parse_mode, text_entities)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**user_id** | **i32** | Unique identifier of the target user who will receive a Telegram Premium subscription | [required] |
**month_count** | **i32** | Number of months the Telegram Premium subscription will be active for the user; must be one of 3, 6, or 12 | [required] |
**star_count** | **i32** | Number of Telegram Stars to pay for the Telegram Premium subscription; must be 1000 for 3 months, 1500 for 6 months, and 2500 for 12 months | [required] |
**text** | Option<**String**> | Text that will be shown along with the service message about the subscription; 0-128 characters |  |
...
**text_entities** | Option<[**Vec<models::MessageEntity>**](models::MessageEntity.md)> | A JSON-serialized list of special entities that appear in the gift text. It can be specified instead of *text\\\\_parse\\\\_mode*. Entities other than “bold”, “italic”, “underline”, “strikethrough”, “spoiler”, and “custom\\\\_emoji” are ignored. |  |

### Return type

[**models::GiftPremiumSubscriptionResponse**](giftPremiumSubscriptionResponse.md)
...
> models::HideGeneralForumTopicResponse post_hide_general_forum_topic(chat_id)
...
[**models::HideGeneralForumTopicResponse**](hideGeneralForumTopicResponse.md)
...
> models::LeaveChatResponse post_leave_chat(chat_id)
leaveChat
...
[**models::LeaveChatResponse**](leaveChatResponse.md)
...
> models::LogOutResponse post_log_out()
logOut
...
[**models::LogOutResponse**](logOutResponse.md)
...
> models::PinChatMessageResponse post_pin_chat_message(chat_id, message_id, business_connection_id, disable_notification)
pinChatMessage
...
[**models::PinChatMessageResponse**](pinChatMessageResponse.md)
...
> models::PostStoryResponse post_post_story(business_connection_id, content, active_period, caption, parse_mode, caption_entities, areas, post_to_chat_page, protect_content)
postStory
...
**business_connection_id** | **String** | Unique identifier of the business connection | [required] |
**content** | [**models::InputStoryContent**](InputStoryContent.md) |  | [required] |
**active_period** | **i32** | Period after which the story is moved to the archive, in seconds; must be one of `6 * 3600`, `12 * 3600`, `86400`, or `2 * 86400` | [required] |
**caption** | Option<**String**> | Caption of the story, 0-2048 characters after entities parsing |  |
**parse_mode** | Option<**String**> | Mode for parsing entities in the story caption. See [formatting options](https://core.telegram.org/bots/api/#formatting-options) for more details. |  |
**caption_entities** | Option<[**Vec<models::MessageEntity>**](models::MessageEntity.md)> | A JSON-serialized list of special entities that appear in the caption, which can be specified instead of *parse\\\\_mode* |  |
**areas** | Option<[**Vec<models::StoryArea>**](models::StoryArea.md)> | A JSON-serialized list of clickable areas to be shown on the story |  |
...
[**models::PostStoryResponse**](postStoryResponse.md)
...
> models::PromoteChatMemberResponse post_promote_chat_member(chat_id, user_id, is_anonymous, can_manage_chat, can_delete_messages, can_manage_video_chats, can_restrict_members, can_promote_members, can_change_info, can_invite_users, can_post_stories, can_edit_stories, can_delete_stories, can_post_messages, can_edit_messages, can_pin_messages, can_manage_topics)
promoteChatMember
...
**can_restrict_members** | Option<**bool**> | Pass *True* if the administrator can restrict, ban or unban chat members, or access supergroup statistics |  |
...
**can_post_messages** | Option<**bool**> | Pass *True* if the administrator can post messages in the channel, or access channel statistics; for channels only |  |
...
[**models::PromoteChatMemberResponse**](promoteChatMemberResponse.md)
...
> models::ReadBusinessMessageResponse post_read_business_message(business_connection_id, chat_id, message_id)
readBusinessMessage
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**business_connection_id** | **String** | Unique identifier of the business connection on behalf of which to read the message | [required] |
**chat_id** | **i32** | Unique identifier of the chat in which the message was received. The chat must have been active in the last 24 hours. | [required] |
**message_id** | **i32** | Unique identifier of the message to mark as read | [required] |

### Return type

[**models::ReadBusinessMessageResponse**](readBusinessMessageResponse.md)
...
> models::RefundStarPaymentResponse post_refund_star_payment(user_id, telegram_payment_charge_id)
refundStarPayment
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**user_id** | **i32** | Identifier of the user whose payment will be refunded | [required] |
**telegram_payment_charge_id** | **String** | Telegram payment identifier | [required] |

### Return type

[**models::RefundStarPaymentResponse**](refundStarPaymentResponse.md)
...
> models::RemoveBusinessAccountProfilePhotoResponse post_remove_business_account_profile_photo(business_connection_id, is_public)
...
[**models::RemoveBusinessAccountProfilePhotoResponse**](removeBusinessAccountProfilePhotoResponse.md)
...
> models::RemoveChatVerificationResponse post_remove_chat_verification(chat_id)
...
[**models::RemoveChatVerificationResponse**](removeChatVerificationResponse.md)
...
> models::RemoveUserVerificationResponse post_remove_user_verification(user_id)
...
[**models::RemoveUserVerificationResponse**](removeUserVerificationResponse.md)
...
> models::ReopenForumTopicResponse post_reopen_forum_topic(chat_id, message_thread_id)
reopenForumTopic
...
[**models::ReopenForumTopicResponse**](reopenForumTopicResponse.md)
...
> models::ReopenGeneralForumTopicResponse post_reopen_general_forum_topic(chat_id)
...
[**models::ReopenGeneralForumTopicResponse**](reopenGeneralForumTopicResponse.md)
...
> models::ReplaceStickerInSetResponse post_replace_sticker_in_set(user_id, name, old_sticker, sticker)
replaceStickerInSet
...
**name** | **String** | Sticker set name | [required] |
**old_sticker** | **String** | File identifier of the replaced sticker | [required] |
**sticker** | [**models::InputSticker**](InputSticker.md) |  | [required] |

### Return type

[**models::ReplaceStickerInSetResponse**](replaceStickerInSetResponse.md)
...
> models::RestrictChatMemberResponse post_restrict_chat_member(chat_id, user_id, permissions, use_independent_chat_permissions, until_date)
restrictChatMember
...
[**models::RestrictChatMemberResponse**](restrictChatMemberResponse.md)
...
> models::RevokeChatInviteLinkResponse post_revoke_chat_invite_link(chat_id, invite_link)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**chat_id** | [**models::RevokeChatInviteLinkRequestChatId**](revokeChatInviteLinkRequest_chat_id.md) |  | [required] |
**invite_link** | **String** | The invite link to revoke | [required] |

### Return type

[**models::RevokeChatInviteLinkResponse**](revokeChatInviteLinkResponse.md)
...
> models::SavePreparedInlineMessageResponse post_save_prepared_inline_message(user_id, result, allow_user_chats, allow_bot_chats, allow_group_chats, allow_channel_chats)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**user_id** | **i32** | Unique identifier of the target user that can use the prepared message | [required] |
**result** | [**models::InlineQueryResult**](InlineQueryResult.md) |  | [required] |
...
[**models::SavePreparedInlineMessageResponse**](savePreparedInlineMessageResponse.md)
...
------------- | ------------- | ------------- | ------------- | -------------
**chat_id** | [**models::SendMessageRequestChatId**](sendMessageRequest_chat_id.md) |  | [required] |
**animation** | Option<**String**> |  | [required] |
...
[**models::SendAnimationResponse**](sendAnimationResponse.md)
...
> models::SendAudioResponse post_send_audio(chat_id, audio, business_connection_id, message_thread_id, caption, parse_mode, caption_entities, duration, performer, title, thumbnail, disable_notification, protect_content, allow_paid_broadcast, message_effect_id, reply_parameters, reply_markup)
sendAudio
...
[**models::SendAudioResponse**](sendAudioResponse.md)
...
> models::SendChatActionResponse post_send_chat_action(chat_id, action, business_connection_id, message_thread_id)
sendChatAction
...
[**models::SendChatActionResponse**](sendChatActionResponse.md)
...
> models::SendContactResponse post_send_contact(chat_id, phone_number, first_name, business_connection_id, message_thread_id, last_name, vcard, disable_notification, protect_content, allow_paid_broadcast, message_effect_id, reply_parameters, reply_markup)
sendContact
...
[**models::SendContactResponse**](sendContactResponse.md)
...
> models::SendDiceResponse post_send_dice(chat_id, business_connection_id, message_thread_id, emoji, disable_notification, protect_content, allow_paid_broadcast, message_effect_id, reply_parameters, reply_markup)
sendDice
...
[**models::SendDiceResponse**](sendDiceResponse.md)
...
> models::SendDocumentResponse post_send_document(chat_id, document, business_connection_id, message_thread_id, thumbnail, caption, parse_mode, caption_entities, disable_content_type_detection, disable_notification, protect_content, allow_paid_broadcast, message_effect_id, reply_parameters, reply_markup)
sendDocument
...
------------- | ------------- | ------------- | ------------- | -------------
**chat_id** | [**models::SendMessageRequestChatId**](sendMessageRequest_chat_id.md) |  | [required] |
**document** | Option<**String**> |  | [required] |
**business_connection_id** | Option<**String**> | Unique identifier of the business connection on behalf of which the message will be sent |  |
**message_thread_id** | Option<**i32**> | Unique identifier for the target message thread (topic) of the forum; for forum supergroups only |  |
**thumbnail** | Option<**String**> |  |  |
...
[**models::SendDocumentResponse**](sendDocumentResponse.md)
...
> models::SendGameResponse post_send_game(chat_id, game_short_name, business_connection_id, message_thread_id, disable_notification, protect_content, allow_paid_broadcast, message_effect_id, reply_parameters, reply_markup)
sendGame
...
[**models::SendGameResponse**](sendGameResponse.md)
...
> models::SendGiftResponse post_send_gift(gift_id, user_id, chat_id, pay_for_upgrade, text, text_parse_mode, text_entities)
sendGift
...
**chat_id** | Option<[**models::SendGiftRequestChatId**](sendGiftRequest_chat_id.md)> |  |  |
...
[**models::SendGiftResponse**](sendGiftResponse.md)
...
[**models::SendInvoiceResponse**](sendInvoiceResponse.md)
...
> models::SendLocationResponse post_send_location(chat_id, latitude, longitude, business_connection_id, message_thread_id, horizontal_accuracy, live_period, heading, proximity_alert_radius, disable_notification, protect_content, allow_paid_broadcast, message_effect_id, reply_parameters, reply_markup)
sendLocation
...
**message_thread_id** | Option<**i32**> | Unique identifier for the target message thread (topic) of the forum; for forum supergroups only |  |
**horizontal_accuracy** | Option<**f64**> | The radius of uncertainty for the location, measured in meters; 0-1500 |  |
**live_period** | Option<**i32**> | Period in seconds during which the location will be updated (see [Live Locations](https://telegram.org/blog/live-locations), should be between 60 and 86400, or 0x7FFFFFFF for live locations that can be edited indefinitely. |  |
...
[**models::SendLocationResponse**](sendLocationResponse.md)
...
> models::SendMediaGroupResponse post_send_media_group(chat_id, media, business_connection_id, message_thread_id, disable_notification, protect_content, allow_paid_broadcast, message_effect_id, reply_parameters)
sendMediaGroup
...
------------- | ------------- | ------------- | ------------- | -------------
**chat_id** | [**models::SendMessageRequestChatId**](sendMessageRequest_chat_id.md) |  | [required] |
**media** | [**Vec<models::SendMediaGroupRequestMediaInner>**](models::SendMediaGroupRequestMediaInner.md) | A JSON-serialized array describing messages to be sent, must include 2-10 items | [required] |
**business_connection_id** | Option<**String**> | Unique identifier of the business connection on behalf of which the message will be sent |  |
**message_thread_id** | Option<**i32**> | Unique identifier for the target message thread (topic) of the forum; for forum supergroups only |  |
...
[**models::SendMediaGroupResponse**](sendMediaGroupResponse.md)
...
> models::SendMessageResponse post_send_message(chat_id, text, business_connection_id, message_thread_id, parse_mode, entities, link_preview_options, disable_notification, protect_content, allow_paid_broadcast, message_effect_id, reply_parameters, reply_markup)
sendMessage
...
> models::SendPaidMediaResponse post_send_paid_media(chat_id, star_count, media, business_connection_id, payload, caption, parse_mode, caption_entities, show_caption_above_media, disable_notification, protect_content, allow_paid_broadcast, reply_parameters, reply_markup)
sendPaidMedia
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**chat_id** | [**models::SendPaidMediaRequestChatId**](sendPaidMediaRequest_chat_id.md) |  | [required] |
...
**parse_mode** | Option<**String**> | Mode for parsing entities in the media caption. See [formatting options](https://core.telegram.org/bots/api/#formatting-options) for more details. |  |
**caption_entities** | Option<[**Vec<models::MessageEntity>**](models::MessageEntity.md)> | A JSON-serialized list of special entities that appear in the caption, which can be specified instead of *parse\\\\_mode* |  |
**show_caption_above_media** | Option<**bool**> | Pass *True*, if the caption must be shown above the message media |  |
**disable_notification** | Option<**bool**> | Sends the message [silently](https://telegram.org/blog/channels-2-0#silent-messages). Users will receive a notification with no sound. |  |
**protect_content** | Option<**bool**> | Protects the contents of the sent message from forwarding and saving |  |
...
[**models::SendPaidMediaResponse**](sendPaidMediaResponse.md)
...
> models::SendPhotoResponse post_send_photo(chat_id, photo, business_connection_id, message_thread_id, caption, parse_mode, caption_entities, show_caption_above_media, has_spoiler, disable_notification, protect_content, allow_paid_broadcast, message_effect_id, reply_parameters, reply_markup)
sendPhoto
...
[**models::SendPhotoResponse**](sendPhotoResponse.md)
...
**business_connection_id** | Option<**String**> | Unique identifier of the business connection on behalf of which the message will be sent |  |
**message_thread_id** | Option<**i32**> | Unique identifier for the target message thread (topic) of the forum; for forum supergroups only |  |
**question_parse_mode** | Option<**String**> | Mode for parsing entities in the question. See [formatting options](https://core.telegram.org/bots/api/#formatting-options) for more details. Currently, only custom emoji entities are allowed |  |
**question_entities** | Option<[**Vec<models::MessageEntity>**](models::MessageEntity.md)> | A JSON-serialized list of special entities that appear in the poll question. It can be specified instead of *question\\\\_parse\\\\_mode* |  |
**is_anonymous** | Option<**bool**> | *True*, if the poll needs to be anonymous, defaults to *True* |  |
**r#type** | Option<**String**> | Poll type, “quiz” or “regular”, defaults to “regular” |  |
...
**explanation_parse_mode** | Option<**String**> | Mode for parsing entities in the explanation. See [formatting options](https://core.telegram.org/bots/api/#formatting-options) for more details. |  |
**explanation_entities** | Option<[**Vec<models::MessageEntity>**](models::MessageEntity.md)> | A JSON-serialized list of special entities that appear in the poll explanation. It can be specified instead of *explanation\\\\_parse\\\\_mode* |  |
**open_period** | Option<**i32**> | Amount of time in seconds the poll will be active after creation, 5-600. Can't be used together with *close\\\\_date*. |  |
**close_date** | Option<**i32**> | Point in time (Unix timestamp) when the poll will be automatically closed. Must be at least 5 and no more than 600 seconds in the future. Can't be used together with *open\\\\_period*. |  |
...
[**models::SendPollResponse**](sendPollResponse.md)
...
> models::SendStickerResponse post_send_sticker(chat_id, sticker, business_connection_id, message_thread_id, emoji, disable_notification, protect_content, allow_paid_broadcast, message_effect_id, reply_parameters, reply_markup)
sendSticker
...
------------- | ------------- | ------------- | ------------- | -------------
**chat_id** | [**models::SendMessageRequestChatId**](sendMessageRequest_chat_id.md) |  | [required] |
**sticker** | Option<**String**> |  | [required] |
**business_connection_id** | Option<**String**> | Unique identifier of the business connection on behalf of which the message will be sent |  |
**message_thread_id** | Option<**i32**> | Unique identifier for the target message thread (topic) of the forum; for forum supergroups only |  |
...
[**models::SendStickerResponse**](sendStickerResponse.md)
...
> models::SendVenueResponse post_send_venue(chat_id, latitude, longitude, title, address, business_connection_id, message_thread_id, foursquare_id, foursquare_type, google_place_id, google_place_type, disable_notification, protect_content, allow_paid_broadcast, message_effect_id, reply_parameters, reply_markup)
sendVenue
...
**address** | **String** | Address of the venue | [required] |
**business_connection_id** | Option<**String**> | Unique identifier of the business connection on behalf of which the message will be sent |  |
**message_thread_id** | Option<**i32**> | Unique identifier for the target message thread (topic) of the forum; for forum supergroups only |  |
**foursquare_id** | Option<**String**> | Foursquare identifier of the venue |  |
**foursquare_type** | Option<**String**> | Foursquare type of the venue, if known. (For example, “arts\\\\_entertainment/default”, “arts\\\\_entertainment/aquarium” or “food/icecream”.) |  |
**google_place_id** | Option<**String**> | Google Places identifier of the venue |  |
**google_place_type** | Option<**String**> | Google Places type of the venue. (See [supported types](https://developers.google.com/places/web-service/supported_types).) |  |
**disable_notification** | Option<**bool**> | Sends the message [silently](https://telegram.org/blog/channels-2-0#silent-messages). Users will receive a notification with no sound. |  |
**protect_content** | Option<**bool**> | Protects the contents of the sent message from forwarding and saving |  |
**allow_paid_broadcast** | Option<**bool**> | Pass *True* to allow up to 1000 messages per second, ignoring [broadcasting limits](https://core.telegram.org/bots/faq#how-can-i-message-all-of-my-bot-39s-subscribers-at-once) for a fee of 0.1 Telegram Stars per message. The relevant Stars will be withdrawn from the bot's balance |  |
**message_effect_id** | Option<**String**> | Unique identifier of the message effect to be added to the message; for private chats only |  |
...
[**models::SendVenueResponse**](sendVenueResponse.md)
...
[**models::SendVideoResponse**](sendVideoResponse.md)
...
> models::SendVideoNoteResponse post_send_video_note(chat_id, video_note, business_connection_id, message_thread_id, duration, length, thumbnail, disable_notification, protect_content, allow_paid_broadcast, message_effect_id, reply_parameters, reply_markup)
sendVideoNote
...
------------- | ------------- | ------------- | ------------- | -------------
**chat_id** | [**models::SendMessageRequestChatId**](sendMessageRequest_chat_id.md) |  | [required] |
**video_note** | Option<**String**> |  | [required] |
**business_connection_id** | Option<**String**> | Unique identifier of the business connection on behalf of which the message will be sent |  |
**message_thread_id** | Option<**i32**> | Unique identifier for the target message thread (topic) of the forum; for forum supergroups only |  |
**duration** | Option<**i32**> | Duration of sent video in seconds |  |
...
[**models::SendVideoNoteResponse**](sendVideoNoteResponse.md)
...
> models::SendVoiceResponse post_send_voice(chat_id, voice, business_connection_id, message_thread_id, caption, parse_mode, caption_entities, duration, disable_notification, protect_content, allow_paid_broadcast, message_effect_id, reply_parameters, reply_markup)
sendVoice
...
------------- | ------------- | ------------- | ------------- | -------------
**chat_id** | [**models::SendMessageRequestChatId**](sendMessageRequest_chat_id.md) |  | [required] |
**voice** | Option<**String**> |  | [required] |
**business_connection_id** | Option<**String**> | Unique identifier of the business connection on behalf of which the message will be sent |  |
**message_thread_id** | Option<**i32**> | Unique identifier for the target message thread (topic) of the forum; for forum supergroups only |  |
**caption** | Option<**String**> | Voice message caption, 0-1024 characters after entities parsing |  |
**parse_mode** | Option<**String**> | Mode for parsing entities in the voice message caption. See [formatting options](https://core.telegram.org/bots/api/#formatting-options) for more details. |  |
**caption_entities** | Option<[**Vec<models::MessageEntity>**](models::MessageEntity.md)> | A JSON-serialized list of special entities that appear in the caption, which can be specified instead of *parse\\\\_mode* |  |
**duration** | Option<**i32**> | Duration of the voice message in seconds |  |
**disable_notification** | Option<**bool**> | Sends the message [silently](https://telegram.org/blog/channels-2-0#silent-messages). Users will receive a notification with no sound. |  |
**protect_content** | Option<**bool**> | Protects the contents of the sent message from forwarding and saving |  |
**allow_paid_broadcast** | Option<**bool**> | Pass *True* to allow up to 1000 messages per second, ignoring [broadcasting limits](https://core.telegram.org/bots/faq#how-can-i-message-all-of-my-bot-39s-subscribers-at-once) for a fee of 0.1 Telegram Stars per message. The relevant Stars will be withdrawn from the bot's balance |  |
**message_effect_id** | Option<**String**> | Unique identifier of the message effect to be added to the message; for private chats only |  |
...
[**models::SendVoiceResponse**](sendVoiceResponse.md)
...
> models::SetBusinessAccountBioResponse post_set_business_account_bio(business_connection_id, bio)
...
[**models::SetBusinessAccountBioResponse**](setBusinessAccountBioResponse.md)
...
> models::SetBusinessAccountGiftSettingsResponse post_set_business_account_gift_settings(business_connection_id, show_gift_button, accepted_gift_types)
...
------------- | ------------- | ------------- | ------------- | -------------
**business_connection_id** | **String** | Unique identifier of the business connection | [required] |
**show_gift_button** | **bool** | Pass True, if a button for sending a gift to the user or by the business account must always be shown in the input field | [required] |
**accepted_gift_types** | [**models::AcceptedGiftTypes**](AcceptedGiftTypes.md) |  | [required] |

### Return type

[**models::SetBusinessAccountGiftSettingsResponse**](setBusinessAccountGiftSettingsResponse.md)
...
> models::SetBusinessAccountNameResponse post_set_business_account_name(business_connection_id, first_name, last_name)
...
------------- | ------------- | ------------- | ------------- | -------------
**business_connection_id** | **String** | Unique identifier of the business connection | [required] |
**first_name** | **String** | The new value of the first name for the business account; 1-64 characters | [required] |
**last_name** | Option<**String**> | The new value of the last name for the business account; 0-64 characters |  |

### Return type

[**models::SetBusinessAccountNameResponse**](setBusinessAccountNameResponse.md)
...
> models::SetBusinessAccountProfilePhotoResponse post_set_business_account_profile_photo(business_connection_id, photo, is_public)
...
------------- | ------------- | ------------- | ------------- | -------------
**business_connection_id** | **String** | Unique identifier of the business connection | [required] |
**photo** | [**models::InputProfilePhoto**](InputProfilePhoto.md) |  | [required] |
...
[**models::SetBusinessAccountProfilePhotoResponse**](setBusinessAccountProfilePhotoResponse.md)
...
> models::SetBusinessAccountUsernameResponse post_set_business_account_username(business_connection_id, username)
...
[**models::SetBusinessAccountUsernameResponse**](setBusinessAccountUsernameResponse.md)
...
> models::SetChatAdministratorCustomTitleResponse post_set_chat_administrator_custom_title(chat_id, user_id, custom_title)
...
[**models::SetChatAdministratorCustomTitleResponse**](setChatAdministratorCustomTitleResponse.md)
...
> models::SetChatDescriptionResponse post_set_chat_description(chat_id, description)
setChatDescription
...
[**models::SetChatDescriptionResponse**](setChatDescriptionResponse.md)
...
> models::SetChatMenuButtonResponse post_set_chat_menu_button(chat_id, menu_button)
setChatMenuButton
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**chat_id** | Option<**i32**> | Unique identifier for the target private chat. If not specified, default bot's menu button will be changed |  |
**menu_button** | Option<[**models::MenuButton**](MenuButton.md)> |  |  |

### Return type

[**models::SetChatMenuButtonResponse**](setChatMenuButtonResponse.md)
...
> models::SetChatPermissionsResponse post_set_chat_permissions(chat_id, permissions, use_independent_chat_permissions)
setChatPermissions
...
[**models::SetChatPermissionsResponse**](setChatPermissionsResponse.md)
...
> models::SetChatPhotoResponse post_set_chat_photo(chat_id, photo)
setChatPhoto
...
[**models::SetChatPhotoResponse**](setChatPhotoResponse.md)
...
> models::SetChatStickerSetResponse post_set_chat_sticker_set(chat_id, sticker_set_name)
setChatStickerSet
...
[**models::SetChatStickerSetResponse**](setChatStickerSetResponse.md)
...
> models::SetChatTitleResponse post_set_chat_title(chat_id, title)
setChatTitle
...
[**models::SetChatTitleResponse**](setChatTitleResponse.md)
...
> models::SetCustomEmojiStickerSetThumbnailResponse post_set_custom_emoji_sticker_set_thumbnail(name, custom_emoji_id)
...
[**models::SetCustomEmojiStickerSetThumbnailResponse**](setCustomEmojiStickerSetThumbnailResponse.md)
...
> models::SetGameScoreResponse post_set_game_score(user_id, score, force, disable_edit_message, chat_id, message_id, inline_message_id)
setGameScore
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**user_id** | **i32** | User identifier | [required] |
**score** | **i32** | New score, must be non-negative | [required] |
...
[**models::SetGameScoreResponse**](setGameScoreResponse.md)
...
> models::SetMessageReactionResponse post_set_message_reaction(chat_id, message_id, reaction, is_big)
setMessageReaction
...
[**models::SetMessageReactionResponse**](setMessageReactionResponse.md)
...
> models::SetMyCommandsResponse post_set_my_commands(commands, scope, language_code)
setMyCommands
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**commands** | [**Vec<models::BotCommand>**](models::BotCommand.md) | A JSON-serialized list of bot commands to be set as the list of the bot's commands. At most 100 commands can be specified. | [required] |
**scope** | Option<[**models::BotCommandScope**](BotCommandScope.md)> |  |  |
**language_code** | Option<**String**> | A two-letter ISO 639-1 language code. If empty, commands will be applied to all users from the given scope, for whose language there are no dedicated commands |  |

### Return type

[**models::SetMyCommandsResponse**](setMyCommandsResponse.md)
...
> models::SetMyDefaultAdministratorRightsResponse post_set_my_default_administrator_rights(rights, for_channels)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**rights** | Option<[**models::ChatAdministratorRights**](ChatAdministratorRights.md)> |  |  |
...
[**models::SetMyDefaultAdministratorRightsResponse**](setMyDefaultAdministratorRightsResponse.md)
...
> models::SetMyDescriptionResponse post_set_my_description(description, language_code)
setMyDescription
...
[**models::SetMyDescriptionResponse**](setMyDescriptionResponse.md)
...
> models::SetMyNameResponse post_set_my_name(name, language_code)
setMyName
...
[**models::SetMyNameResponse**](setMyNameResponse.md)
...
> models::SetMyShortDescriptionResponse post_set_my_short_description(short_description, language_code)
...
[**models::SetMyShortDescriptionResponse**](setMyShortDescriptionResponse.md)
...
> models::SetPassportDataErrorsResponse post_set_passport_data_errors(user_id, errors)
...
------------- | ------------- | ------------- | ------------- | -------------
**user_id** | **i32** | User identifier | [required] |
**errors** | [**Vec<models::PassportElementError>**](models::PassportElementError.md) | A JSON-serialized array describing the errors | [required] |

### Return type

[**models::SetPassportDataErrorsResponse**](setPassportDataErrorsResponse.md)
...
> models::SetStickerEmojiListResponse post_set_sticker_emoji_list(sticker, emoji_list)
setStickerEmojiList
...
------------- | ------------- | ------------- | ------------- | -------------
**sticker** | **String** | File identifier of the sticker | [required] |
**emoji_list** | [**Vec<String>**](String.md) | A JSON-serialized list of 1-20 emoji associated with the sticker | [required] |

### Return type

[**models::SetStickerEmojiListResponse**](setStickerEmojiListResponse.md)
...
> models::SetStickerKeywordsResponse post_set_sticker_keywords(sticker, keywords)
setStickerKeywords
...
------------- | ------------- | ------------- | ------------- | -------------
**sticker** | **String** | File identifier of the sticker | [required] |
**keywords** | Option<[**Vec<String>**](String.md)> | A JSON-serialized list of 0-20 search keywords for the sticker with total length of up to 64 characters |  |

### Return type

[**models::SetStickerKeywordsResponse**](setStickerKeywordsResponse.md)
...
> models::SetStickerMaskPositionResponse post_set_sticker_mask_position(sticker, mask_position)
...
------------- | ------------- | ------------- | ------------- | -------------
**sticker** | **String** | File identifier of the sticker | [required] |
**mask_position** | Option<[**models::MaskPosition**](MaskPosition.md)> |  |  |

### Return type

[**models::SetStickerMaskPositionResponse**](setStickerMaskPositionResponse.md)
...
> models::SetStickerPositionInSetResponse post_set_sticker_position_in_set(sticker, position)
setStickerPositionInSet
...
------------- | ------------- | ------------- | ------------- | -------------
**sticker** | **String** | File identifier of the sticker | [required] |
**position** | **i32** | New sticker position in the set, zero-based | [required] |

### Return type

[**models::SetStickerPositionInSetResponse**](setStickerPositionInSetResponse.md)
...
> models::SetStickerSetThumbnailResponse post_set_sticker_set_thumbnail(name, user_id, format, thumbnail)
...
[**models::SetStickerSetThumbnailResponse**](setStickerSetThumbnailResponse.md)
...
> models::SetStickerSetTitleResponse post_set_sticker_set_title(name, title)
setStickerSetTitle
...
[**models::SetStickerSetTitleResponse**](setStickerSetTitleResponse.md)
...
> models::SetUserEmojiStatusResponse post_set_user_emoji_status(user_id, emoji_status_custom_emoji_id, emoji_status_expiration_date)
setUserEmojiStatus
...
**emoji_status_expiration_date** | Option<**i32**> | Expiration date of the emoji status, if any |  |

### Return type

[**models::SetUserEmojiStatusResponse**](setUserEmojiStatusResponse.md)
...
> models::SetWebhookResponse post_set_webhook(url, certificate, ip_address, max_connections, allowed_updates, drop_pending_updates, secret_token)
setWebhook
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**url** | **String** | HTTPS URL to send updates to. Use an empty string to remove webhook integration | [required] |
**certificate** | Option<[**serde_json::Value**](serde_json::Value.md)> |  |  |
...
**max_connections** | Option<**i32**> | The maximum allowed number of simultaneous HTTPS connections to the webhook for update delivery, 1-100. Defaults to *40*. Use lower values to limit the load on your bot's server, and higher values to increase your bot's throughput. |  |[default to 40]
...
[**models::SetWebhookResponse**](setWebhookResponse.md)
...
> models::StopMessageLiveLocationResponse post_stop_message_live_location(business_connection_id, chat_id, message_id, inline_message_id, reply_markup)
...
[**models::StopMessageLiveLocationResponse**](stopMessageLiveLocationResponse.md)
...
> models::StopPollResponse post_stop_poll(chat_id, message_id, business_connection_id, reply_markup)
stopPoll
...
[**models::StopPollResponse**](stopPollResponse.md)
...
> models::TransferBusinessAccountStarsResponse post_transfer_business_account_stars(business_connection_id, star_count)
...
------------- | ------------- | ------------- | ------------- | -------------
**business_connection_id** | **String** | Unique identifier of the business connection | [required] |
**star_count** | **i32** | Number of Telegram Stars to transfer; 1-10000 | [required] |

### Return type

[**models::TransferBusinessAccountStarsResponse**](transferBusinessAccountStarsResponse.md)
...
> models::TransferGiftResponse post_transfer_gift(business_connection_id, owned_gift_id, new_owner_chat_id, star_count)
transferGift
...
------------- | ------------- | ------------- | ------------- | -------------
**business_connection_id** | **String** | Unique identifier of the business connection | [required] |
**owned_gift_id** | **String** | Unique identifier of the regular gift that should be transferred | [required] |
**new_owner_chat_id** | **i32** | Unique identifier of the chat which will own the gift. The chat must be active in the last 24 hours. | [required] |
**star_count** | Option<**i32**> | The amount of Telegram Stars that will be paid for the transfer from the business account balance. If positive, then the *can\\\\_transfer\\\\_stars* business bot right is required. |  |

### Return type

[**models::TransferGiftResponse**](transferGiftResponse.md)
...
> models::UnbanChatMemberResponse post_unban_chat_member(chat_id, user_id, only_if_banned)
unbanChatMember
...
[**models::UnbanChatMemberResponse**](unbanChatMemberResponse.md)
...
> models::UnbanChatSenderChatResponse post_unban_chat_sender_chat(chat_id, sender_chat_id)
unbanChatSenderChat
...
[**models::UnbanChatSenderChatResponse**](unbanChatSenderChatResponse.md)
...
> models::UnhideGeneralForumTopicResponse post_unhide_general_forum_topic(chat_id)
...
[**models::UnhideGeneralForumTopicResponse**](unhideGeneralForumTopicResponse.md)
...
> models::UnpinAllChatMessagesResponse post_unpin_all_chat_messages(chat_id)
...
[**models::UnpinAllChatMessagesResponse**](unpinAllChatMessagesResponse.md)
...
> models::UnpinAllForumTopicMessagesResponse post_unpin_all_forum_topic_messages(chat_id, message_thread_id)
...
[**models::UnpinAllForumTopicMessagesResponse**](unpinAllForumTopicMessagesResponse.md)
...
> models::UnpinAllGeneralForumTopicMessagesResponse post_unpin_all_general_forum_topic_messages(chat_id)
...
[**models::UnpinAllGeneralForumTopicMessagesResponse**](unpinAllGeneralForumTopicMessagesResponse.md)
...
> models::UnpinChatMessageResponse post_unpin_chat_message(chat_id, business_connection_id, message_id)
unpinChatMessage
...
[**models::UnpinChatMessageResponse**](unpinChatMessageResponse.md)
...
> models::UpgradeGiftResponse post_upgrade_gift(business_connection_id, owned_gift_id, keep_original_details, star_count)
upgradeGift
...
------------- | ------------- | ------------- | ------------- | -------------
**business_connection_id** | **String** | Unique identifier of the business connection | [required] |
**owned_gift_id** | **String** | Unique identifier of the regular gift that should be upgraded to a unique one | [required] |
**keep_original_details** | Option<**bool**> | Pass True to keep the original gift text, sender and receiver in the upgraded gift |  |
**star_count** | Option<**i32**> | The amount of Telegram Stars that will be paid for the upgrade from the business account balance. If `gift.prepaid_upgrade_star_count > 0`, then pass 0, otherwise, the *can\\\\_transfer\\\\_stars* business bot right is required and `gift.upgrade_star_count` must be passed. |  |

### Return type

[**models::UpgradeGiftResponse**](upgradeGiftResponse.md)
...
> models::UploadStickerFileResponse post_upload_sticker_file(user_id, sticker, sticker_format)
uploadStickerFile
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**user_id** | **i32** | User identifier of sticker file owner | [required] |
**sticker** | Option<[**serde_json::Value**](serde_json::Value.md)> |  | [required] |
**sticker_format** | **String** | Format of the sticker, must be one of “static”, “animated”, “video” | [required] |

### Return type

[**models::UploadStickerFileResponse**](uploadStickerFileResponse.md)
...
> models::VerifyChatResponse post_verify_chat(chat_id, custom_description)
verifyChat
...
[**models::VerifyChatResponse**](verifyChatResponse.md)
...
> models::VerifyUserResponse post_verify_user(user_id, custom_description)
verifyUser
...
[**models::VerifyUserResponse**](verifyUserResponse.md)
