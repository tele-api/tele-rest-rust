...
**duration** | Option<**i32**> | Duration of sent animation in seconds | [optional]
**width** | Option<**i32**> | Animation width | [optional]
**height** | Option<**i32**> | Animation height | [optional]
**thumbnail** | Option<**String**> |  | [optional]
**caption** | Option<**String**> | Animation caption (may also be used when resending animation by *file\\_id*), 0-1024 characters after entities parsing | [optional]
**parse_mode** | Option<**String**> | Mode for parsing entities in the animation caption. See [formatting options](https://core.telegram.org/bots/api/#formatting-options) for more details. | [optional]
...
**has_spoiler** | Option<**bool**> | Pass *True* if the animation needs to be covered with a spoiler animation | [optional]
