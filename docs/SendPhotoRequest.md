...
**photo** | Option<**String**> |  | 
**caption** | Option<**String**> | Photo caption (may also be used when resending photos by *file\\_id*), 0-1024 characters after entities parsing | [optional]
**parse_mode** | Option<**String**> | Mode for parsing entities in the photo caption. See [formatting options](https://core.telegram.org/bots/api/#formatting-options) for more details. | [optional]
...
**has_spoiler** | Option<**bool**> | Pass *True* if the photo needs to be covered with a spoiler animation | [optional]
