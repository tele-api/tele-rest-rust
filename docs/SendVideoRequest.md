...
**video** | Option<**String**> |  | 
**duration** | Option<**i32**> | Duration of sent video in seconds | [optional]
**width** | Option<**i32**> | Video width | [optional]
**height** | Option<**i32**> | Video height | [optional]
**thumbnail** | Option<**String**> |  | [optional]
**cover** | Option<**String**> |  | [optional]
**start_timestamp** | Option<**i32**> | Start timestamp for the video in the message | [optional]
**caption** | Option<**String**> | Video caption (may also be used when resending videos by *file\\_id*), 0-1024 characters after entities parsing | [optional]
**parse_mode** | Option<**String**> | Mode for parsing entities in the video caption. See [formatting options](https://core.telegram.org/bots/api/#formatting-options) for more details. | [optional]
...
**has_spoiler** | Option<**bool**> | Pass *True* if the video needs to be covered with a spoiler animation | [optional]
**supports_streaming** | Option<**bool**> | Pass *True* if the uploaded video is suitable for streaming | [optional]
